        ...
        return(
            <div>
                <div className="info-box-dark">
                    ...
                    <p>• Collected returned orders and updated the status report to ensure the issue is dealt with in a timely fashion.</p>
                    <p>• Entered a new order’s information into an order management system using an RF scanner.</p>
                </div>
            </div>
        );
    }
